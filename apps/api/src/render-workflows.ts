...
export const RENDER_WORKFLOW_TIMEOUT_SECONDS = 300
export const RENDER_WORKFLOW_RETRY_WAIT_MS = 7 * 60 * 1_000
const retry = { maxRetries: 2, waitDurationMs: RENDER_WORKFLOW_RETRY_WAIT_MS, backoffScaling: 1.5 }

export const runTeracCampaignStudyTask = task(
  { name: 'runTeracCampaignStudy', retry, timeoutSeconds: RENDER_WORKFLOW_TIMEOUT_SECONDS, plan: 'starter' },
...
export const discoverResearchLeadsTask = task(
  { name: 'discoverResearchLeads', retry, timeoutSeconds: RENDER_WORKFLOW_TIMEOUT_SECONDS, plan: 'starter' },
...
export const sendNordlichtOutreachTask = task(
  { name: 'sendNordlichtOutreach', retry, timeoutSeconds: RENDER_WORKFLOW_TIMEOUT_SECONDS, plan: 'starter' },
...
export const runBandNegotiationTask = task(
  { name: 'runBandNegotiation', retry, timeoutSeconds: RENDER_WORKFLOW_TIMEOUT_SECONDS, plan: 'starter' },
...
export const reviewContractAndCreateEnvelopeTask = task(
  { name: 'reviewContractAndCreateEnvelope', retry, timeoutSeconds: RENDER_WORKFLOW_TIMEOUT_SECONDS, plan: 'starter' },
